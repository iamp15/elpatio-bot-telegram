// Script para probar /verprecios con porcentaje de ganancias
console.log("📊 Probando comando /verprecios con ganancias...\n");
...
async function testCommand() {
  try {
    ...
    console.log("🚀 Ejecutando comando /verprecios...");

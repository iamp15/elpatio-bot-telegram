// Script para probar /verhistorial después de la corrección
console.log("🧪 Probando comando /verhistorial (corregido)...\n");
...
async function testCommand() {
  try {
    ...
    await adminCommands.handleVerHistorial(mockBot, testMsg);
